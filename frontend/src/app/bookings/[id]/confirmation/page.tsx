      ...
      <div className="max-w-container-max w-full mx-auto max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-section-gap">
          ...
          <div className="md:col-span-2 bg-surface-container-lowest rounded-xl shadow-md p-stack-md border border-outline-variant/30 flex flex-col sm:flex-row gap-stack-md items-start sm:items-center relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
            <div
              className="w-full sm:w-32 h-32 rounded-lg bg-surface-container-high flex-shrink-0 bg-cover bg-center"
              style={{ backgroundImage: `url('${booking.event.coverImageUrl || ""}')` }}
            ></div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button className="w-full sm:w-auto bg-gradient-to-r from-primary to-secondary text-on-primary font-body text-body font-semibold py-3 px-8 rounded-full shadow-md hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group">
            <span className="material-symbols-outlined transition-transform group-hover:-translate-y-1">download</span>
            Download Tickets (PDF)
          </button>
          <button className="w-full sm:w-auto bg-transparent border border-primary text-primary font-body text-body font-semibold py-3 px-8 rounded-full hover:bg-primary-fixed/50 transition-colors duration-300 flex items-center justify-center gap-2">
