...
| :--- | :--- | :--- |
| `./mvnw test` passing | 194 / 194 passing (all tests including Docker-based integration tests) | 100% |
| Test coverage | 83% INSTRUCTION (7,206/8,644) — verified via `./mvnw clean verify`; JaCoCo gate ✅ PASSED | 80%+ |
